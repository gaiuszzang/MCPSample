...
class LLMManager {
    ...
    enum class LLMType(
        ...
        Gemini_2_5_Flash_Preview(llmName = "Gemini 2.5 Flash(Preview)", llmService = LLMService.Gemini, modelName = "gemini-2.5-flash-preview-04-17"),
        Gemini_2_5_Pro_Preview(llmName = "Gemini 2.5 Pro(Preview)", llmService = LLMService.Gemini, modelName = "gemini-2.5-pro-preview-03-25"),

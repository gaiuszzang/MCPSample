...
import io.groovin.mcpsample.mcp.localserver.notification.DatabaseProvider
import io.groovin.mcpsample.mcp.localserver.notification.UserNotification
import io.groovin.mcpsample.mcp.localserver.notification.isNotificationServiceEnabled
...
class NotificationReadTool(
    ...
    private val dbDao = DatabaseProvider.getDao(context)
